...
class createNotifikasiPushRrp extends Page {
  ...
  get titlePage() {
    return $("#headerNotifikasi");
  }
  get formPage() {
    return $(
      "#wrapper > div > fuse-content > app-notification-create > div > div.content.p-24 > div > form > div:nth-child(1) > h2"
    );
  }
  get inputTextBuatNotifikasi() {
    return $('[placeholder="Judul Notifikasi"]');
  }
  get inputTextKontenNotifikasi() {
    return $$('[spellcheck="true"]');
  }
  get radioBtnGrupPengguna() {
    return $$("#mat-radio-3");
  }
  get timeJamTerbit() {
    return $('[formcontrolname="time"]');
  }
  get jam1() {
  ...
  get inputTextNamaHalaman() {
    return $('[placeholder="Nama Halaman"]');
  }
  get inputTextIsiHalaman() {
    return $$('[contenteditable="true"]');
  }
  get radioBtnTipeKonten() {
    return $$("#mat-radio-11");
  }
  get radioBtnBatasUmur() {
    return $$("#mat-radio-14");
  }
  get buttonSimpan() {
    return $("button.confirmation-button.mat-raised-button");
  }
