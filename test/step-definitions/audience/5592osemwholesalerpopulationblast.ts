...
describe("[PRINCIPAL] 5592. Create Population Blast Wholesaler", () => {
  ...
  it("I am on form create Audience Baru on Population Blast page, input and submit data", async function () {
    ...
    await OsemPage.inputSelectBoxSingle(15, "Testing - Wholesaler HMS SoM Area");
    ...
    // =========TAMBAH DATA - 5=========
    await OsemPage.clickButtonTambahData();
    await OsemPage.inputSelectBoxSingle(31, "Dist Hub - Wholesaler Transaction");
