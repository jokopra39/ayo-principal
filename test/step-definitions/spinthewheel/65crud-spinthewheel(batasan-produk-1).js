...
import stwBatasanProduk1 from "../../../src/pageobjects/spinthewheel/65crud-spinthewheel(batasan-produk-1).page";
...
it("I search and select data in Batasan Berdasarkan Produk (.*)", async (batasan_berdasarkan_produk) => {
  await stwBatasanProduk1.batasanBerdasarkanProduk(batasan_berdasarkan_produk);
});
