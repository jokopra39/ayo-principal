...
it("I input Nilai Transaksi Minimal1 (.*)", async (nilai_transaksi_minimal1) => {
  await stwBatasanKategori1AND.nilaiTransaksiMinimal1(nilai_transaksi_minimal1);
});
...
it("I input Nilai Transaksi Minimal2 (.*)", async (nilai_transaksi_minimal2) => {
  await stwBatasanKategori1AND.nilaiTransaksiMinimal2(nilai_transaksi_minimal2);
});
