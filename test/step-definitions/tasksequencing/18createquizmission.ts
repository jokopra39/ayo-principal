...
describe('[PRINCIPAL] 18. Create Quiz Mission', () => {
  ...
  it("System should be show detail template tugas page with type quiz", async () => {
  ...
  it("I search a Trade Program name", async () => {
