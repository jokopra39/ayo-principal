...
allureReporter.addTestId(
  "[PRINCIPAL] 107. Detail Verification Approval Semua Approved"
);
allureReporter.addFeature("Detail Verification Approval Semua Approved");
...
it("I search a Task Verification", async () => {
  await TaskVerificationPage.searchTaskVerif(
    dataTest.taskVerification.searchByTsmName107
  );
