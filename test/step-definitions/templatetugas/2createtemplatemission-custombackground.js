...
allureReporter.addTestId(
  "[PRINCIPAL] 02. Create Template Mission Custom Background"
);
allureReporter.addFeature("Create Template Tugas with custom background");
...
it("I fill form with custom background and submit", async () => {
  await FormTemplateTugasPage.inputJudulTugas(
    dataTest.templateTugas.judulTugas2,
    dataTest.templateTugas.namaLainMisi2,
    dataTest.templateTugas.deskripsiTugas2
  );
  ...
  await FormTemplateTugasPage.customBgMisi();
