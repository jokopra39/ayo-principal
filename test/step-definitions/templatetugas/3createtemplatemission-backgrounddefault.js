...
allureReporter.addTestId(
  "[PRINCIPAL] 03. Create Template Mission Background Default"
);
allureReporter.addFeature("Create Template Tugas with background default");
...
it("I fill form with background default and submit", async () => {
  await FormTemplateTugasPage.inputJudulTugas(
    dataTest.templateTugas.judulTugas3,
    dataTest.templateTugas.namaLainMisi3,
    dataTest.templateTugas.deskripsiTugas3
  );
