...
export const config: Options.Testrunner = {
    ...
    capabilities: [
        {
            ...
            maxInstances: 1,
            specs: [
                // './test/step-definitions/trs/5159-trs_system_variable.ts',
                './test/step-definitions/trs/5493-trs_report.ts'
            ]
        },
    ],
    ...
    reporters: [
        ...
        'spec',
        // ['junit', {
        //     outputDir: './reports/junit/xml',
        //     outputFileFormat: function (options) { // optional
        //         return `results-${options.cid}.${new Date().toDateString()}.xml`
        //     }
        // }],
        // ['allure', {
